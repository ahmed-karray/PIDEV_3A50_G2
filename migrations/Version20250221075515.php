 ...
 */
final class Version20250221075515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appointment (id INT AUTO_INCREMENT NOT NULL, planning_id INT NOT NULL, user_id INT NOT NULL, start_at DATETIME NOT NULL, INDEX IDX_FE38F8443D865311 (planning_id), INDEX IDX_FE38F844A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE planning (id INT AUTO_INCREMENT NOT NULL, doctor_id INT NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, daily_start_time TIME NOT NULL, daily_end_time TIME NOT NULL, INDEX IDX_D499BFF687F4FB17 (doctor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
