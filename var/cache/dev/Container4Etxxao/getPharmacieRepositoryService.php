 ...
 */
class getPharmacieRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PharmacieRepository.php';

        return $container->privates['App\\Repository\\PharmacieRepository'] = new \App\Repository\PharmacieRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
