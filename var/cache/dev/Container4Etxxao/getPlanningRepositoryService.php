 ...
 */
class getPlanningRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlanningRepository' shared autowired service.
     *
     * @return \App\Repository\PlanningRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlanningRepository.php';

        return $container->privates['App\\Repository\\PlanningRepository'] = new \App\Repository\PlanningRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
