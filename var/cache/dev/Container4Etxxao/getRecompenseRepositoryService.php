 ...
 */
class getRecompenseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RecompenseRepository' shared autowired service.
     *
     * @return \App\Repository\RecompenseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RecompenseRepository.php';

        return $container->privates['App\\Repository\\RecompenseRepository'] = new \App\Repository\RecompenseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
