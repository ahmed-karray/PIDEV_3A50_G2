...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\GestionPlanning\\AdminAppointmentController' => 'getAdminAppointmentControllerService',
            'App\\Controller\\GestionPlanning\\AdminPlanningController' => 'getAdminPlanningControllerService',
            'App\\Controller\\GestionPlanning\\AppointmentController' => 'getAppointmentControllerService',
            'App\\Controller\\GestionPlanning\\PlanningController' => 'getPlanningControllerService',
            'App\\Controller\\GestionUser\\DoctorRegistrationController' => 'getDoctorRegistrationControllerService',
            'App\\Controller\\GestionUser\\ForgotPasswordController' => 'getForgotPasswordControllerService',
            'App\\Controller\\GestionUser\\GestionUserController' => 'getGestionUserControllerService',
            'App\\Controller\\GestionUser\\ProfileController' => 'getProfileControllerService',
            'App\\Controller\\GestionUser\\RegistrationChoiceController' => 'getRegistrationChoiceControllerService',
            'App\\Controller\\GestionUser\\RegistrationController' => 'getRegistrationControllerService',
            'App\\Controller\\GestionUser\\ResetPasswordController' => 'getResetPasswordControllerService',
            'App\\Controller\\GestionUser\\SecurityController' => 'getSecurityControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('4LkgJM1v4j', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sBcoLY+pBY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ka1CbWbawV', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eoefITZwFe', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AdminController', 'App\\Controller\\GestionPlanning\\AdminAppointmentController', 'App\\Controller\\GestionPlanning\\AdminPlanningController', 'App\\Controller\\GestionPlanning\\AppointmentController', 'App\\Controller\\GestionPlanning\\PlanningController', 'App\\Controller\\GestionUser\\DoctorRegistrationController', 'App\\Controller\\GestionUser\\ForgotPasswordController', 'App\\Controller\\GestionUser\\GestionUserController', 'App\\Controller\\GestionUser\\ProfileController', 'App\\Controller\\GestionUser\\RegistrationChoiceController', 'App\\Controller\\GestionUser\\RegistrationController', 'App\\Controller\\GestionUser\\ResetPasswordController', 'App\\Controller\\GestionUser\\SecurityController', 'App\\Controller\\HomeController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mscdOyIe8k', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('vfKvv7FnAs', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Exm2RDp7NB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lcU5lbmH8C', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o2m52bE95J', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bXSoNvVjhS', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('G+V7P8Bl5M', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'diploma_directory' => (\dirname(__DIR__, 4).'/public/assets/diplomas'),
