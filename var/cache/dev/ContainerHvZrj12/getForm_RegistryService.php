...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\GestionPlanning\\AppointmentType' => ['privates', 'App\\Form\\GestionPlanning\\AppointmentType', 'getAppointmentTypeService', true],
            'App\\Form\\GestionUser\\DoctorRegistrationFormType' => ['privates', 'App\\Form\\GestionUser\\DoctorRegistrationFormType', 'getDoctorRegistrationFormTypeService', true],
            'App\\Form\\GestionUser\\ForgotPasswordType' => ['privates', 'App\\Form\\GestionUser\\ForgotPasswordType', 'getForgotPasswordTypeService', true],
            'App\\Form\\GestionUser\\RegistrationFormType' => ['privates', 'App\\Form\\GestionUser\\RegistrationFormType', 'getRegistrationFormTypeService', true],
            'App\\Form\\GestionUser\\ResetPasswordType' => ['privates', 'App\\Form\\GestionUser\\ResetPasswordType', 'getResetPasswordTypeService', true],
            ...
            'App\\Form\\GestionPlanning\\AppointmentType' => '?',
            'App\\Form\\GestionUser\\DoctorRegistrationFormType' => '?',
            'App\\Form\\GestionUser\\ForgotPasswordType' => '?',
            'App\\Form\\GestionUser\\RegistrationFormType' => '?',
            'App\\Form\\GestionUser\\ResetPasswordType' => '?',
